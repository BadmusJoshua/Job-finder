...
<htm class="no-js" lang="zxx">
    ...
    <body>
        ...
        <div class="">
            <div class="col-lg-12 col-md-8 col-sm-12 align-items-center justify-content-center">
                <h3 class="mb-30">Sign Up</h3>
                <form action="#" class="w-lg-50% w-md-70% w-sm-100%">
                    <div class="row">
                        <div class="mt-10 col-lg-4 col-sm-12">
                            <input type="text" name="first_name" placeholder="First Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'First Name'" required class="single-input">
                        </div>
                        <div class="mt-10 col-lg-4 col-sm-12">
                            <input type="text" name="middle_name" placeholder="Middle Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Middle Name'" required class="single-input">
                        </div>
                        <div class="mt-10 col-lg-4 col-sm-12">
                    ...
                    <div class="row">
                        <div class="input-group-icon mt-10 col-lg-4 col-sm-12">
                    ...
                    <div class="row">
                        <div class="input-group-icon mt-10 col-lg-6 col-sm-12">
                        ...
                        <div class="input-group-icon mt-10 col-lg-6 col-sm-12 mt-10">
                                ...
                                <div class="single-footer-caption mb-50">
                                    <div class="footer-tittle">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="#">Phone : +234 803 581 8535</a></li>
                                            <li><a href="#">Email : joshuabadmus574@gmail.com</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
